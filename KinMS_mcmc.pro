...
function KinMS_mcmc,param,_extra=_extra,finaloutput=finaloutput,iters=iters,outputll=outputll
  ...
  save,finalparams,outputvalue,obspars,outputll,filename=finaloutput+"_parsave.sav"
